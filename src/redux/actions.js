...
export function createUser(user) {
  ...
  return (dispatch) => {
    fetch("https://kick--app.herokuapp.com/api/v1/users", {
      method: "POST",
      headers: {
...
export const logInUser = (user) => {
  ...
  return (dispatch) => {
    fetch("https://kick--app.herokuapp.com/api/v1/login", {
      method: "POST",
      headers: {
        accepts: "application/json",
        "content-type": "application/json",
...
export const getProfileFetch = () => {
  ...
  return (dispatch) => {
    if (token) {
      return fetch("https://kick--app.herokuapp.com/api/v1/profile", {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
export function createProject(project, tags) {
  const token = Cookies.get("jwt");
  return (dispatch) => {
    fetch("https://kick--app.herokuapp.com/api/v1/projects", {
      method: "POST",
      headers: {
        accepts: "application/json",
        "content-type": "application/json",
...
export function postAddVote(project, user, vote_action) {
  const token = Cookies.get("jwt");
  return (dispatch) => {
    fetch(`https://kick--app.herokuapp.com/api/v1//votes`, {
      method: "POST",
      headers: {
        accepts: "application/json",
        "content-type": "application/json",
...
export function postSaveProject(project, user) {
  const token = Cookies.get("jwt");
  return (dispatch) =>
    fetch(`https://kick--app.herokuapp.com/api/v1/save`, {
      method: "POST",
      headers: {
        accepts: "application/json",
        "content-type": "application/json",
...
export function getSavedProjects(user) {
  const token = Cookies.get("jwt");
  return (dispatch) => {
    return fetch(`https://kick--app.herokuapp.com/api/v1/save/${user?.id}`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        Accept: "application/json",
...
export function removeSavedProject(savedUserid) {
  const token = Cookies.get("jwt");
  return (dispatch) =>
    fetch(`https://kick--app.herokuapp.com/api/v1/save/${savedUserid}`, {
      method: "DELETE",
      headers: {
        accepts: "application/json",
        "content-type": "application/json",
...
export function postClaimedProject(project, user) {
  const token = Cookies.get("jwt");
  return (dispatch) =>
    fetch(`https://kick--app.herokuapp.com/api/v1/claim`, {
      method: "POST",
      headers: {
        accepts: "application/json",
        "content-type": "application/json",
...
export function unClaimProject(claimedUserid) {
  const token = Cookies.get("jwt");
  return (dispatch) =>
    fetch(`https://kick--app.herokuapp.com/api/v1/claim/${claimedUserid}`, {
      method: "DELETE",
      headers: {
        accepts: "application/json",
        "content-type": "application/json",
...
export function getClaimed(user) {
  const token = Cookies.get("jwt");
  return (dispatch) => {
    return fetch(`https://kick--app.herokuapp.com/api/v1/claimed/${user?.id}`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        Accept: "application/json",
...
export function getAllClaimed() {
  const token = Cookies.get("jwt");
  return (dispatch) => {
    return fetch(`https://kick--app.herokuapp.com/api/v1/claimed`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        Accept: "application/json",
...
export function postStartProject(project) {
  const token = Cookies.get("jwt");
  return (dispatch) =>
    fetch(`https://kick--app.herokuapp.com/api/v1/start_project`, {
      method: "POST",
      headers: {
        accepts: "application/json",
        "content-type": "application/json",
...
export function postCompleteProject(project) {
  const token = Cookies.get("jwt");
  return (dispatch) =>
    fetch(`https://kick--app.herokuapp.com/api/v1/complete_project`, {
      method: "POST",
      headers: {
        accepts: "application/json",
        "content-type": "application/json",
...
export function postAbandonProject(project) {
  const token = Cookies.get("jwt");
  return (dispatch) =>
    fetch(`https://kick--app.herokuapp.com/api/v1/abandon_project`, {
      method: "POST",
      headers: {
        accepts: "application/json",
        "content-type": "application/json",
